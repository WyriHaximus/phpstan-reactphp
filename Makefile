...
all-raw: ## The real runs everything, but due to sponge it has to be ran inside DOCKER_RUN ##U##
	$(MAKE) update-phpstan-extension composer-validate syntax-php composer-normalize rector-upgrade cs-fix cs stan unit-testing mutation-testing composer-require-checker composer-unused backward-compatibility-check ## Count: 13
...
help: ## Show this help ####
	@printf "%s\n" ''
	@printf "%s\n" '             ._   o   |_     _.        o   ._ _           _    /   ._    |_    ._     _   _|_    _.   ._    __   ._    _     _.    _   _|_'
