...
final class UseLoopStaticProxiesRuleTest extends RuleTestCase
{
    /** @return list<string> */
    ...
    public function testAllTheLoopMethods(LoopMethod $loopMethod): void
    {
        $this->analyse([$loopMethod->file], [
            [
                $loopMethod->staticProxyError,
                $loopMethod->staticProxyLine,
                $loopMethod->tip,
            ],
        ]);
    }

    public function testCallsThatAreNotStaticProxyCalls(): void
    {
        $this->analyse([
