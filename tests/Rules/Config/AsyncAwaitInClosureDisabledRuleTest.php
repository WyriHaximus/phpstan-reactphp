...
final class AsyncAwaitInClosureDisabledRuleTest extends RuleTestCase
{
    /** @return list<string> */
    ...
    {
        return new WrapAwaitingClosuresInAsyncRule(new RulesConfig(
    ...
    {
        $this->analyse([
            dirname(__DIR__, 3) . DIRECTORY_SEPARATOR . 'utils' . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'async' . DIRECTORY_SEPARATOR . 'await-in-closure.php',
        ], []);
    }
}
