...
{
    private const array FUNCTION_LIST = ['fclose' => ['name' => 'fclose',
...
], 'file_get_contents' => ['name' => 'file_get_contents',
...
], 'file_put_contents' => ['name' => 'file_put_contents',
...
], 'time_nanosleep' => ['name' => 'time_nanosleep',
...
'tip' => 'Please consult the documentation for more information: https://reactphp.org/promise-timer/#sleep'
], 'time_sleep_until' => ['name' => 'time_sleep_until',
...
'tip' => 'Please consult the documentation for more information: https://reactphp.org/promise-timer/#sleep'
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (array_key_exists($functionName, self::FUNCTION_LIST)) {
            return [RuleErrorBuilder::message(self::FUNCTION_LIST[$functionName]['message'
])->identifier(self::FUNCTION_LIST[$functionName]['identifier'
])->build()];
        }
        return [];
    }
